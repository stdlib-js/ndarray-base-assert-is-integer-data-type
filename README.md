...
```javascript
isIntegerDataType = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-assert-is-integer-data-type@v0.3.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-assert-is-integer-data-type/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/ndarray-base-assert-is-integer-data-type/actions/workflows/test.yml?query=branch:v0.3.0
